...
class AuditEventType(str, enum.Enum):
    ...
    USER_GROUP_ENROLLED = "USER_GROUP_ENROLLED"

    # Address book events
    ADDRESS_BOOK_ENTRY_ADDED = "ADDRESS_BOOK_ENTRY_ADDED"
    ADDRESS_BOOK_ENTRY_REMOVED = "ADDRESS_BOOK_ENTRY_REMOVED"

    # Policy set events
    POLICY_SET_CREATED = "POLICY_SET_CREATED"
    POLICY_SET_UPDATED = "POLICY_SET_UPDATED"
    POLICY_SET_ASSIGNED = "POLICY_SET_ASSIGNED"
    POLICY_RULE_ADDED = "POLICY_RULE_ADDED"
    POLICY_RULE_UPDATED = "POLICY_RULE_UPDATED"
    POLICY_RULE_REMOVED = "POLICY_RULE_REMOVED"

    # Conditional control events
    KYT_SKIPPED = "KYT_SKIPPED"
